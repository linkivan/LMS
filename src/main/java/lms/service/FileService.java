...
public interface FileService {
	...
	int 	  createAssignmentResponse(FileItem responseFile, CourseModel course, String assignmentName, String username);
	int 	  createAssignmentFile(FileItem responseFile, CourseModel course, String assignmentName, String username);
