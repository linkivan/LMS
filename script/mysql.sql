...
CREATE TABLE `course` (
  ...
  PRIMARY KEY (`id`),
  KEY `fk_course_user1_idx` (`instructor_id`),
  CONSTRAINT `fk_course_user1` FOREIGN KEY (`instructor_id`) REFERENCES `user` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
INSERT INTO `course` VALUES (1,'123','14:00-15:00',NULL,'enpm611','fall2016'),(2,'123','14:00-15:00',NULL,'enpm612','fall2016'),(3,'123z','14:00-15:00',NULL,'enpm614','fall2016');
...
INSERT INTO `user` VALUES (1,'student1','1518596cc02033138901826200c26c60',1,'ROLE_STU',1,0);
...
-- Dump completed on 2016-11-28 22:27:56
